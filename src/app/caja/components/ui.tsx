...
/**
 * Local Brand It UI kit for the Caja module.
 * Replaces fashiongr's `@/components/ui` barrel. Same export names and prop
 * APIs as the originals (Modal, ConfirmModal, EmptyState, ScrollableTable,
 * SkeletonTable), but modals follow the Brand It pattern:
 * createPortal + `fixed inset-0 bg-black/60` overlay + centered panel +
 * `animate-fade-in-up`, with body-scroll lock. No autoFocus, no slide-up,
 * no body.position=fixed.
 */
