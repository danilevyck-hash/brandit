    ...
    <>
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <img src="/brandit-logo.svg" alt="Confecciones Boston" className="w-9 h-9 rounded" />
        ...
        <table className="w-full text-xs border-collapse mb-4">
          ...
          <tbody>
            ...
            <tr className="font-bold bg-gray-50">
              <td colSpan={4} className="border border-gray-300 px-2 py-1.5 text-right uppercase text-xs">
